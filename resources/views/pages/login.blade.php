...
@section('content')
<div class="container vcenter" style="margin-top: 160px">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="font-weight: bold">Halaman Login</div>
                    ...
                    <form method="POST" action="{{ route('doLogin') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn" style="background-color: #141617;color: white">
                                    Login
                                </button>
